  ...
  >
    <head>
      ...
      <style>
        ...
        [data-ogsb] .es-button.es-button-1647979809532 {
        ...
        */
        ...
        .es-button-border {
          ...
          border-color: #9f2d30 #9f2d30 #9f2d30 #9f2d30;
          background: 1px;
                                        ...
                                        >
                                          <tbody>
                                            <tr>
                                              ...
                                              >
                                                <p>
                                                  ¿Olvidaste tu contraseña?. No te preocupes, dale click al boton de abajo para recuperar tu contraseña.
                                                </p>
                                              </td>
                                            </tr>
                                            <tr>
                                              ...
                                              >
                                                <span class="es-button-border"
                                                  ><a
                                                    href="${url}"
                                                    class="es-button es-button-1647979809532"
                                                    target="_blank"
                                                    style="
                                                                  ...
                                                                  <tbody>
                                                                      <tr>
                                                                          <td class="esd-block-text es-p30t es-p30r es-p30l" align="center">
                                                                              <h3 style="color: #111111;">¿Más información?</h3>
                                                                          </td>
                                                                      </tr>
                                                                      <tr>
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr>
                                                                          <td align="left" class="esd-block-text es-p25t">
                                                                              <p>Recibiste este correo porque solicitaste una recuperación de tu contraseña.</p>
                                                                          </td>
                                                                      </tr>
